  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <nav className="sticky top-0 z-10 shadow-sm bg-white py-4 px-6 flex justify-between items-center">
        <h1 className="text-2xl font-bold tracking-tight text-purple-600">Cipher Flow</h1>
        {account && (
          ...
          {account ? (
            ...
            <div className="text-center py-12 bg-white border border-gray-200 rounded-xl shadow-sm">
              <div className="max-w-md mx-auto">
                ...
                <p className="text-gray-500">Connect your wallet to access Cipher Flow features and start managing your assets.</p>
              </div>
            </div>
          )}
        </div>
